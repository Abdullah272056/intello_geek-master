...
class FavouritePageScreen extends StatefulWidget {
  ...
  FavouritePageScreen(this.darkOrLightStatus);

  @override
  State<FavouritePageScreen> createState() =>
      _FavouritePageScreenState(this.darkOrLightStatus);
...
class _FavouritePageScreenState extends State<FavouritePageScreen> {
  ...
  _FavouritePageScreenState(this._darkOrLightStatus);
              ...
              children: [
                ...
                if(_shimmerStatus)...[
                  ...
                  Expanded(
                    child: ListView.builder(
                        padding: EdgeInsets.zero,
                        itemCount: _myFavouriteCourse==null||_myFavouriteCourse.length<=0?0:
                        _myFavouriteCourse.length,
                        shrinkWrap: true,
                        physics: ClampingScrollPhysics(),
                        itemBuilder: (BuildContext context, int index) {
                          return _buildFavouriteItemForList(_myFavouriteCourse[index]);
                        }),
                  )
                ],
  ...
  Widget _buildFavouriteItemForList(var response) {
    return InkResponse(
      onTap: (){
        // _showToast("ok");
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Container(
                                            ...
                                            child: FadeInImage.assetNetwork(
                                              ...
                                              image:
                                              "$BASE_URL"+response['my_course_information']["channel_name_info"]["channel_name_logo"],
                                              imageErrorBuilder:
                                                  (context, url, error) =>
                                                  Image.asset(
                                                    'assets/images/empty.png',
                                      ...
                                      Flexible(
                                        child: Container(
                                          ...
                                          child: Text(
                                            response['my_course_information']["channel_name_info"]["channel_name"].toString(),
                                            overflow: TextOverflow.clip,
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 8,
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Column(
                                          children: [
                                            Text(
                                              response["my_course_information"]["course_duration"].toInt().toString()+" min",
                                              overflow:
                      ...
                      children: [
                        Align(
                          ...
                          child: Flex(
                            ...
                            children:  [
                              Expanded(
                                child: Text(
                                  response["my_course_information"]["course_title"].toString(),
                              ...
                              Text(
                                "\$"+response["my_course_information"]["course_price_info"][0]["new_price"].toString(),
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            RatingBarIndicator(
                              //rating:4,
                              rating:double.parse(response['my_course_information']["avg_rating"].toString()),
                            ...
                            Text(
                              response['my_course_information']["avg_rating"].toString(),
                            ...
                            Container(
                              ...
                              child: InkResponse(
                                onTap: () {
                                  _removeMyFavouriteCourseDataList(response["course_favourite_id"].toString());
  ...
  _getMyFavouriteCourseDataList() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        try {
          var response = await get(
            Uri.parse(
                '$BASE_URL_API$SUB_URL_API_MY_FAVOURITE_COURSE_LIST$_userId/'),
            headers: {
  ...
  _removeMyFavouriteCourseDataList(String favouriteId) async {
    try {
      final result = await InternetAddress.lookup('example.com');
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
      //  _shimmerStatus = true;
        try {
          var response = await get(
            Uri.parse(
                '$BASE_URL_API$SUB_URL_API_REMOVE_MY_FAVOURITE_COURSE_LIST$favouriteId/'),
            headers: {
              //"Authorization": "Token $accessToken",
