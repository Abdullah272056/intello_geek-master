...
class YourApplicationsScreen6 extends StatefulWidget {
  const YourApplicationsScreen6({Key? key}) : super(key: key);


  @override
  State<YourApplicationsScreen6> createState() => _YourApplicationsScreenState();
}

class _YourApplicationsScreenState extends State<YourApplicationsScreen6> {
