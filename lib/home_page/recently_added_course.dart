...
class RecentlyAddedSeeMoreScreen extends StatefulWidget {
  const RecentlyAddedSeeMoreScreen({Key? key}) : super(key: key);

  @override
  State<RecentlyAddedSeeMoreScreen> createState() =>
      _RecentlyAddedSeeMoreScreenState();
}

class _RecentlyAddedSeeMoreScreenState
    extends State<RecentlyAddedSeeMoreScreen> {
  ...
  var businessAndCompanyTextColor,financeTextColor,iAAndBigDataTextColor,digitalMarketingTextColor;

  var businessAndCompanyTabColor,financeTabColor,iAAndBigDataTabColor,digitalMarketingTabColor;

  String languageStatus="bn";

  List _recentlyAddedCourse = [];
  ...
  void initState() {
    ...
    loadUserIdFromSharePref().then((_) {
      _getRecentlyAddedCourseDataList();
      if(_darkOrLightStatus==1){
        businessAndCompanyTextColor = Colors.white;
        financeTextColor = Colors.black;
        iAAndBigDataTextColor = Colors.black;
        digitalMarketingTextColor = Colors.black;

        businessAndCompanyTabColor =intello_bg_color;
        financeTabColor = Colors.transparent;
        iAAndBigDataTabColor = Colors.transparent;
        digitalMarketingTabColor = Colors.transparent;
      }
      else{
        businessAndCompanyTextColor = Colors.white;
        financeTextColor = Colors.white;
        iAAndBigDataTextColor = Colors.white;
        digitalMarketingTextColor = Colors.white;
          ...
          children: [
            InkResponse(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: businessAndCompanyTabColor,
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: businessAndCompanyTextColor,
                      fontSize: 15,
            ...
            InkResponse(
              onTap: () {
                setState(() {
                  if(_darkOrLightStatus==1){
                    businessAndCompanyTextColor = Colors.black;
                    financeTextColor = Colors.white;
                    iAAndBigDataTextColor = Colors.black;
                    digitalMarketingTextColor = Colors.black;
                    businessAndCompanyTabColor = Colors.transparent;
                    financeTabColor =intello_bg_color;
                    iAAndBigDataTabColor = Colors.transparent;
                    digitalMarketingTabColor = Colors.transparent;
                    tab_status = 2;
              ...
              onTap: () {
                setState(() {
                  if(_darkOrLightStatus==1){
                    ...
                    businessAndCompanyTabColor = Colors.transparent;
                    financeTabColor = Colors.transparent;
                    iAAndBigDataTabColor =intello_bg_color;
                    digitalMarketingTabColor = Colors.transparent;
                    tab_status = 3;
                  }
                  else{
            ...
            InkResponse(
              onTap: () {
                setState(() {
                  if(_darkOrLightStatus==1){
                    ...
                    financeTabColor = Colors.transparent;
                    iAAndBigDataTabColor = Colors.transparent;
                    digitalMarketingTabColor =intello_bg_color;
                    tab_status = 4;
                    ...
                    financeTabColor = Colors.transparent;
                    iAAndBigDataTabColor = Colors.transparent;
                    digitalMarketingTabColor =intello_bd_color;
                    tab_status = 4;
              ...
              child: Container(
                ...
                padding: const EdgeInsets.only(
                    left: 10.0, right: 10.0, bottom: 12, top: 12),
                decoration: BoxDecoration(
                  color: digitalMarketingTabColor,
                  borderRadius: const BorderRadius.only(
                      topRight: Radius.circular(40.0),
                      bottomRight: Radius.circular(40.0),
                      topLeft: Radius.circular(40.0),
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: digitalMarketingTextColor,
                      fontSize: 15,
                      fontWeight: FontWeight.normal),
                ),
              ),
              ...
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                      itemCount: _recentlyAddedCourse==null||_recentlyAddedCourse.length<=0?0:
                      _recentlyAddedCourse.length,
                      shrinkWrap: true,
              ...
              children: [
                Expanded(
                  child: ListView.builder(
                      itemCount:_recentlyAddedCourse==null||_recentlyAddedCourse.length<=0?0:_recentlyAddedCourse.length,
                      shrinkWrap: true,
                      physics: ClampingScrollPhysics(),
                      itemBuilder: (BuildContext context, int index) {
                        return _buildRecentlyCourseItemForList(_recentlyAddedCourse[index]);
                      }),
                )
              ],
            )));
  ...
  Widget _buildRecentlyCourseItemForGrid(var response) {
    return Container(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Container(
                                    ...
                                    child: Text(response["channel_name"]["channel_name"].toString(),
  ...
  Widget _buildRecentlyCourseItemForList(var response) {
    return InkResponse(
      onTap: (){
        // _showToast("ok");
...
//add favourite list
  ...
  _getRecentlyAddedCourseDataList() async {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        try {
          var response = await get(
            Uri.parse(
                '$BASE_URL_API$SUB_URL_API_Recently_added_course_see_more$tab_status'),
            headers: {
              //"Authorization": "Token $accessToken",
             // "Accept-Language": "en",
         ...
         // _shimmerStatus=false;
          ...
          if (response.statusCode == 200) {
            setState(() {
              _shimmerStatus = false;
               var data = jsonDecode(response.body);
              _recentlyAddedCourse = data["data"]['course_info'];
            });
          }
          else {
            Fluttertoast.cancel();
            ...
            //width: 180,
              ...
              decoration: new BoxDecoration(
                ...
                boxShadow: [BoxShadow(
                  ...
                  color: _darkOrLightStatus == 1?Colors.grey.withOpacity(.25):Colors.grey.withOpacity(.30),
                  //  blurRadius: 20.0, // soften the shadow
